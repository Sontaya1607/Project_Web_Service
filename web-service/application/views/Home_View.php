...
<html lang="en">
<head>
	<title>ทำเพื่อการศึกษาเท่านั้น</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="#">For education only</a>
		</div>
...
<?php 
	/*
    if (!isset($this->session->userdata['logged_in'])) {
        echo "<a id='a' href='" .base_url(). "user_authentication/register'Register</a>";
    }
    if (!isset($this->session->userdata['logged_in'])) {
        echo "<a id='a' href='" .base_url(). "user_authentication/login'><span class='fa fa-sign-in'></span>&nbsp;Login</a></li>";
    } else {
    	echo "<a id='a' href='" .base_url(). "user_authentication/logout'><span class='fa fa-sign-out'></span>&nbsp;Logout</a></li>";
    }

    if (isset($this->session->userdata['logged_in'])) {
        echo "<a id='a' href='". base_url()."user/profile/". $id . "'>
        <span class='fa fa-user-circle-o'></span>&nbsp;" . $username ."</a></li>";
	}
	*/
	//echo "<a id='a' href='" .base_url(). "user_authentication/register'>Register</a>".'<br>';
	//echo "<a id='a' href='" .base_url(). "user_authentication/login'>Login</a>".'<br>';
	//echo "<a id='a' href='" .base_url(). "user_authentication/logout'>Logout</a>".'<br>';
?>

<!-- Logo Register  Login <br>-->
<!--
	<div class="container">
		<h2>Bordered Table</h2>
		<p>The .table-bordered class adds borders to a table: ควยไรสัสแชมป์ จากพี่บ่าว</p>            
	...
	ทำเพื่อการศึกษาเท่านั้นssssasdasdzzzzzzzxczxcas <br>
	<table border=1>
		<tr>
		...
		<tr>
			<td>
				<a href="<?php //echo base_url();?>examination/examination/<?php //echo $row['subject_id']; ?>"><?php echo $row['subject_name']; ?></a>
			</td>
		</tr>
		<?php //} ?>
	</table>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand">BabyEnglish ควยไรแชมป์ จากพี่บ่าว</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="well">
       ...
       <button class="btn">Start a free test</button>
      </div>
